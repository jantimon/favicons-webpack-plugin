# Snapshot report for `test/usage.test.mjs`

The actual snapshot is saved in `usage.test.mjs.snap`.

Generated by [AVA](https://avajs.dev).

## should take a string as argument
...
## should take an object with just the logo as argument
